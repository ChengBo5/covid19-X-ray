...
def dpn92(pretrained=False, test_time_pool=False, **kwargs):
    ...
    if pretrained:
        ...
        pretrained_dict = load_state_dict_from_url(model_urls['dpn92-extra'])
...
class DPN(nn.Module):
    def __init__(self, small=False, num_init_features=64, k_r=96, groups=32,
                 ...
                 num_classes=3, test_time_pool=False):
        ...
        self.classifierl = nn.Conv2d(in_chs, num_classes, kernel_size=1, bias=True)
